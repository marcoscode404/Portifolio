...
<template>
  <main class="overflow-x-hidden">
    <div class="img">
      ...
      <GlobalModal :open="isOpen" @close="isOpen = false">
        <template #description>
            <p class=" font-bold">Portifolio em Construção!</p>
        </template>
      </GlobalModal>
      ...
      <!-- banner -->
      <div class="h-full flex flex-col justify-center  max-w-7xl m-auto ">

        <div class="rounded-full border-2 overflow-hidden border-white flex justify-center mb-2 mx-auto h-44 w-44 bg-white">
          <img src="../assets/perfil.jpeg" alt="">
        </div>

        <div class="box-texto mt-2">
          <span class="font-bold text-white">Olá, Eu Sou</span>
